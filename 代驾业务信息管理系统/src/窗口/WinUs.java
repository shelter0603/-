...
public class WinUs extends JFrame{
    ...
    void init(){
        ...
        box1.add(l1=new JLabel("尾    号："));
        l1.setFont(font);
        box1.add(ph=new JTextField(15));
        box2.add(l2=new JLabel("姓    名："));
        l2.setFont(font);
        box2.add(na=new JTextField(15));
        box3.add(l3=new JLabel("接待状况："));
        l3.setFont(font);
        box3.add(wo=new JTextField(15));
        box4.add(l5=new JLabel("客户地址："));
        l5.setFont(font);
        box4.add(dz=new JTextField(15));
        box5.add(button1=new JButton("录入"));
        box5.add(button2=new JButton("修改"));
        box5.add(button3=new JButton("查询"));
        box5.add(button4=new JButton("删除"));
...
class Listener3 implements ActionListener{
    WinUs view;
    File driver=new File("D:\\desktop\\代驾业务信息管理系统\\代驾业务信息管理系统\\src","users.txt");
    File d=new File("D:\\desktop\\代驾业务信息管理系统\\代驾业务信息管理系统\\src","driver.txt");
    void setview(WinUs view){
        this.view=view;
    }
            ...
            if(e.getActionCommand().equals("修改")){
                ...
                while((str=reader.readLine())!=null){
                    ...
                    if(view.ph.getText().equals(Der[0])){
                        ...
                        der[i].setdz(view.dz.getText());
                        view.l4.setText("查询找到该客户，修改完成");
                        k=1;
                    }
                    i++;
                }
